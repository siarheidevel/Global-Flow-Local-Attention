...
class Dior_Dense_Flow(BaseModel):
    """
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['input_P1','input_P2','input_BP1', 'input_BP2',
            'input_D1','input_D2','img_gen','flow_fields'
            ]
    ...
    def forward(self):
        ...
        self.flow_fields, _ = self.net_FlowG(self.input_P1, 
            torch.cat((self.input_BP1,self.input_D1), dim=1),
            torch.cat((self.input_BP2,self.input_D2), dim=1))
