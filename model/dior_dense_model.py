...
class Dior_Dense(BaseModel):
    ...
    def __init__(self, opt):
        ...
        #     ,
        self.visual_names = ['input_P1','input_P2','img_gen','inter_images',
            'input_BP1', 'input_BP2','input_SP1','input_SP2','input_D1','input_D2','input_M1',
            'flow_fields','soft_mask_list'
            ]
        ...
        self.net_FlowG = init_network(network.generator.PoseFlowNetGenerator(image_nc=3, structure_nc=18+48, ngf=64, img_f=512,
                        encoder_layer=4, attn_layer=opt.attn_layer,
                        norm='instance', activation='LeakyReLU',
                        use_spect=opt.use_spect_g, use_coord=False), opt)

        
        self.net_DiorG = init_network(dior_single_model.Generator2(image_nc=3, structure_nc=18+48, 
            norm='instance', activation='LeakyReLU',
    ...
    def set_input(self, input):
        ...
        input_D1,input_D2= input['D1'],input['D2']
        ...
        if len(self.gpu_ids) > 0:
            ...
            self.input_D1 = input_D1.cuda(self.gpu_ids[0], non_blocking=True)
            self.input_D2 = input_D2.cuda(self.gpu_ids[0], non_blocking=True)
    ...
    def forward(self):
        ...
        self.flow_fields = self.net_FlowG(self.input_P1, 
            torch.cat((self.input_BP1,self.input_D1), dim=1),
            torch.cat((self.input_BP2,self.input_D2), dim=1))[0]
        # take h/4, w/4 flow                
        ...
        self.img_gen,self.soft_mask_list, self.inter_images = self.net_DiorG(self.vgg,
            ...
            self.input_P1, None, self.input_SP1, torch.cat((self.input_BP2,self.input_D2), dim=1), self.input_SP2)
